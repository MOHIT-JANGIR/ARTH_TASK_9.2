...
""")
         ...
         if int(p)==12:
          ...
          subprocess.getoutput("sed -i 's/data/name/2' hdfs-site-master.xml")
         ...
         input("press enter to keep using this sub-menu : ")
          ...
          if input1=="file":
              ...
              subprocess.getoutput("cp {} /var/www/html/".format(input1))
              ...
              subprocess.getoutput("curl http://{}:/{}".format(pubip,input1))
          else:
     ...
     while True:
        ...
        while True:  
          ...
          if input1=="file":
              ...
              subprocess.getoutput("scp -i slave1.pem {} ec2-user@{}:/var/www/html/".format(input1,pubip))
...
""")
         p=input("plz enter ur choice : ")
         if int(p)==11:
          subprocess.getoutput("ssh -i slave1.pem ec2-user@{} sudo rpm -ivh jdk-8u171-linux-x64.rpm".format(pubip))
          subprocess.getoutput("ssh -i slave1.pem ec2-user@{} sudo rpm -ivh hadoop-1.2.1-1.x86_64.rpm --force ".format(pubip))
          subprocess.getoutput("ssh -i slave1.pem ec2-user@{} sudo mkdir /nn1".format(pubip))
          subprocess.getoutput("sed -i 's/masterip/0.0.0.0/g' /home/ec2-user/core-site-master-remote.xml".format(pubip))
          subprocess.getoutput("sed -i 's/data/name/g' /home/ec2-user/hdfs-site-master-remote.xml".format(pubip))
          subprocess.getoutput("sed -i 's/dn/nn1/g' /home/ec2-user/hdfs-site-master.xml".format(pubip))
